...
<body class="homepage">
                            ...
                            <ul class="navbar-nav justify-content-end flex-grow-1 gap-1 gap-md-5 pe-3">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownShop">
                                        ...
                                        <li>
                                            <a href="index.html" class="dropdown-item item-anchor">Shop Four Column
                                            </a>
                                        </li>
                                        <li>
                                            <a href="index.html" class="dropdown-item item-anchor">Shop Four Column
                                        ...
                                        <li>
                                            <a href="index.html" class="dropdown-item item-anchor">Shop Six Column
                                            </a>
                                        </li>
                                        <li>
                                            <a href="index.html" class="dropdown-item item-anchor">Shop Six Column
                            ...
                            <div class="swiper-slide">
                                <div class="banner-item image-zoom-effect">
                                    <div class="image-holder">
                                        <a href="#">
                                            <img src="{{ asset('assets/images/banner-image-' . $i . '.jpg') }}"
                                    ...
                                    <div class="banner-content py-4">
                                        ...
                                        <p>Scelerisque duis aliquam qui lorem ipsum dolor amet, consectetur adipiscing
                                            elit.</p>
                                        <div class="btn-left">
                                            <a href="#"
    ...
    <section class="features py-5">
        <div class="container">
            <div class="row">
                @php
                    $icons = ['calendar', 'shopping-bag', 'gift', 'arrow-cycle'];
                    $titles = ['Book An Appointment', 'Pick up in store', 'Special packaging', 'Free global returns'];
                    $delays = [0, 300, 600, 900];
                @endphp

                @foreach ($icons as $index => $icon)
                    <div class="col-md-3 text-center" data-aos="fade-in" data-aos-delay="{{ $delays[$index] }}">
                        <div class="py-5">
                            <svg width="38" height="38" viewBox="0 0 24 24">
                                <use xlink:href="{{ asset('assets/icons/icons.svg#' . $icon) }}"></use>
                            </svg>
                            <h4 class="element-title text-capitalize my-3">{{ $titles[$index] }}</h4>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="cat-item image-zoom-effect">
                            <div class="image-holder">
                                <a href="index.html">
                                    <img src="{{ asset('assets/images/cat-item1.jpg') }}" alt="categories"
                    ...
                    <div class="col-md-4">
                        <div class="cat-item image-zoom-effect">
                            <div class="image-holder">
                                <a href="index.html">
                                    <img src="{{ asset('assets/images/cat-item2.jpg') }}" alt="categories"
                                        class="product-image img-fluid">
                                </a>
                            </div>
                            <div class="category-content">
                    ...
                    <div class="col-md-4">
                        <div class="cat-item image-zoom-effect">
                            <div class="image-holder">
                                <a href="index.html">
                                    <img src="{{ asset('assets/images/cat-item3.jpg') }}" alt="categories"
                                        class="product-image img-fluid">
                                </a>
                            </div>
                            <div class="category-content">
        ...
        <div class="container">
            ...
            <div class="swiper product-swiper open-up" data-aos="zoom-out">
                <div class="swiper-wrapper d-flex">
                    @php
                        $products = [
                            ['img' => 'product-item-1.jpg', 'name' => 'Dark florish onepiece', 'price' => '$95.00'],
                            ['img' => 'product-item-2.jpg', 'name' => 'Baggy Shirt', 'price' => '$55.00'],
                            ['img' => 'product-item-3.jpg', 'name' => 'Cotton off-white shirt', 'price' => '$65.00'],
                            ['img' => 'product-item-4.jpg', 'name' => 'Crop sweater', 'price' => '$50.00'],
                            ['img' => 'product-item-10.jpg', 'name' => 'Crop sweater', 'price' => '$70.00'],
                        ];
                    @endphp
                        ...
                        <div class="swiper-slide">
                            <div class="product-item image-zoom-effect link-effect">
                                <div class="image-holder position-relative">
                                    <a href="index.html">
                                        <img src="{{ asset('assets/images/' . $product['img']) }}" alt="categories"
                                            class="product-image img-fluid">
                                    </a>
        ...
        <div class="container">
            ...
            <div class="swiper product-swiper open-up" data-aos="zoom-out">
                <div class="swiper-wrapper d-flex">
                    @php
                        $bestsellers = [
                            ['img' => 'product-item-4.jpg', 'name' => 'Dark florish onepiece', 'price' => '$95.00'],
                            ['img' => 'product-item-3.jpg', 'name' => 'Baggy Shirt', 'price' => '$55.00'],
                            ['img' => 'product-item-5.jpg', 'name' => 'Cotton off-white shirt', 'price' => '$65.00'],
                            ['img' => 'product-item-6.jpg', 'name' => 'Handmade crop sweater', 'price' => '$50.00'],
                            ['img' => 'product-item-9.jpg', 'name' => 'Dark florish onepiece', 'price' => '$70.00'],
                            ['img' => 'product-item-10.jpg', 'name' => 'Cotton off-white shirt', 'price' => '$70.00'],
                        ];
                    @endphp
                    ...
                    @foreach ($bestsellers as $product)
                        <div class="swiper-slide">
                            <div class="product-item image-zoom-effect link-effect">
                                <div class="image-holder">
                                    <a href="index.html">
                                        <img src="{{ asset('assets/images/' . $product['img']) }}" alt="product"
                                            class="product-image img-fluid">
                                    </a>
                                    <a href="index.html" class="btn-icon btn-wishlist">
                                        <svg width="24" height="24" viewBox="0 0 24 24">
                                    ...
                                    <div class="product-content">
                                        ...
                                        <a href="index.html" class="text-decoration-none" data-after="Add to cart">
                                            <span>{{ $product['price'] }}</span>
                                        </a>
                                    </div>
                                </div>
                ...
                <div class="video-content open-up" data-aos="zoom-out">
                    ...
                    <div class="video-player">
                        <a class="youtube" href="https://www.youtube.com/embed/pjtsGzQjFM4">
                            ...
                            <img src="{{ asset('assets/images/text-pattern.png') }}" alt="pattern"
                                class="text-rotate">
                        </a>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="swiper product-swiper open-up" data-aos="zoom-out">
                <div class="swiper-wrapper d-flex">
                    @php
                        $related = [
                            ['img' => 'product-item-5.jpg', 'name' => 'Dark florish onepiece', 'price' => '$95.00'],
                            ['img' => 'product-item-6.jpg', 'name' => 'Baggy Shirt', 'price' => '$55.00'],
                            ['img' => 'product-item-7.jpg', 'name' => 'Cotton off-white shirt', 'price' => '$65.00'],
                            ['img' => 'product-item-8.jpg', 'name' => 'Handmade crop sweater', 'price' => '$50.00'],
                            ['img' => 'product-item-1.jpg', 'name' => 'Handmade crop sweater', 'price' => '$70.00'],
                        ];
                    @endphp
    ...
    <section class="blog py-5">
        <div class="container">
            ...
            <div class="row">
                @php
                    $blogs = [
                        ['img' => 'post-image1.jpg', 'title' => 'How to look outstanding in pastel'],
                        ['img' => 'post-image2.jpg', 'title' => 'Top 10 fashion trend for summer'],
                        ['img' => 'post-image3.jpg', 'title' => 'Crazy fashion with unique moment'],
                    ];
                @endphp
                    ...
                    <div class="col-md-4">
                        <article class="post-item">
                            <div class="post-image">
                                <a href="index.html">
                                    <img src="{{ asset('assets/images/' . $blog['img']) }}" alt="image"
        ...
        <div class="container">
            <div class="row">
                <div class="logo-content d-flex flex-wrap justify-content-between">
                    @for ($i = 1; $i <= 5; $i++)
                        <img src="{{ asset('assets/images/logo' . $i . '.png') }}" alt="logo"
    ...
    <section class="newsletter bg-light"
        style="background: url('{{ asset('assets/images/pattern-bg.png') }}') no-repeat;">
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-6 col-sm-4 col-md-2">
                    <div class="insta-item">
                        <a href="https://www.instagram.com/templatesjungle/" target="_blank">
                            <img src="{{ asset('assets/images/insta-item' . $i . '.jpg') }}" alt="instagram"
            ...
            <div class="row d-flex flex-wrap justify-content-between py-5">
                    ...
                    <div class="footer-menu footer-menu-001">
                        ...
                        <div class="social-links">
                            <ul class="list-unstyled d-flex flex-wrap gap-3">
                                @foreach (['facebook', 'twitter', 'youtube', 'pinterest', 'instagram'] as $icon)
                                    <li>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-menu footer-menu-002">
                        ...
                        <ul class="menu-list list-unstyled text-uppercase border-animation-left fs-6">
                            <li class="menu-item"><a href="index.html" class="item-anchor">Home</a></li>
                            <li class="menu-item"><a href="index.html" class="item-anchor">About</a></li>
                            <li class="menu-item"><a href="blog.html" class="item-anchor">Services</a></li>
                            <li class="menu-item"><a href="styles.html" class="item-anchor">Single item</a></li>
                            <li class="menu-item"><a href="#" class="item-anchor">Contact</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-menu footer-menu-004 border-animation-left">
                        ...
                        <p>Do you need support? Give us a call. <a href="tel:+43720115278" class="item-anchor">+43 720
                                11 52 78</a></p>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 text-end">
                        <p>© Copyright 2022 Kaira. All rights reserved. Design by
